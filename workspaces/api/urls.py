...
from .views import WorkspaceViewSet, InvitePerEmailView, CategoryViewSet, TaskViewSet, SubtasksViewSet
...
workspace_router.register(r'subtasks', SubtasksViewSet, basename='workspace-subtask')
